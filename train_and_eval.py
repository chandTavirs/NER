...
def demo(model, parameters, model_testing_sentences, word_to_id, char_to_id, tag_to_id):
    # parameters
    ...
    for sentence in model_testing_sentences:
        ...
        words = [word_to_id[lower_case(w, lower) if lower_case(w, lower) in word_to_id else '<UNK>'] for w in
                 str_words]
